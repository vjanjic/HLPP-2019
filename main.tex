...
%
%% for example
%% \texttt{while\ ((x=getc(stream))\ \textgreater{}=\ 0)\ ...} For example,
%% \begin{lstlisting}
%% EXAMPLE
%% \end{lstlisting}
%% 
...
%}
%\end{lstlisting}
%% For example, the simple \texttt{while} loop,
%% \begin{lstlisting}
%% while (std::cin >> x) {
%%     #pragma grppi farm stage 4
%%     xs.push_back(w(acc, x));
%%     #pragma grppi seq stage
%%     cout << xs.pop_front() << endl;
%% }
%% \end{lstlisting}
%% 
%\noindent
...
\begin{axis}[
 ...
 %  title=Speedups for Image Convolution GrPPI Farm
   ...
   \legend{GrPPI pthreads, GrPPI TBB, Native TBB}
\end{axis} 
...
%   title=Speedups for Ant Colony
   ...
   \legend{GrPPI pthreads, GrPPI TBB, TBB}
\end{axis} 
 \end{tikzpicture}
 \label{acresults}}
 \end{figure}
