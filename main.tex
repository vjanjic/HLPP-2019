...
Ant Colony Optimisation (ACO)~\cite{Dorigo-aco-book} is a metaheuristic used 
...
$w_i$ (\lstinline{w} in the code below).%\footnoteremark{Miniature fonts again}
